        ...
        <div className="grid md:grid-cols-2 gap-10 items-center bg-slate-900/50 backdrop-blur-md border border-[#1E90FF]/20 rounded-2xl p-8 shadow-2xl hover:shadow-blue-500/10 transition duration-500">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="bg-blue-900/40 text-white border border-blue-400/30 px-3 py-1 rounded-full text-sm">
                React
              </span>
              <span className="bg-blue-900/40 text-white border border-blue-400/30 px-3 py-1 rounded-full text-sm">
                Tailwind
              </span>
              <span className="bg-blue-900/40 text-white border 400 border border-blue-400/30 px-3 py-1 rounded-full text-sm">
                UI/UX
              </span>
            </div>
